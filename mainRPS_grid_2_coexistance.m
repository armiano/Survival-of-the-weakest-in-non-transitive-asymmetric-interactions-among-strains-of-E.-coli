...
pS =  linspace(0.05,0.42,8);%probability of strain S to be killed by R
...
%     plot(gridSTotFrac,'g')
%     hold off
%     path=['/Users/ariannamiano/Desktop/PhD/ModelRPSPlate/Coexistance_sweep/pR_0.1_pS_0.5_pP_from0.4_to_0.5' num2str(arraypP(arr)) '_trial' num2str(trial) '.svg'] ;
%     saveas(gcf,path);
%     close all
