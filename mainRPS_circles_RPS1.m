...
radius = 10; %range to try from 6 to 23 %for the version without (1-n1) is from to 16
radius2 = 50;
radius3 = 75;
distance = 0;
positiony = ny/2;
...
pP =  linspace(0.05,0.4,8); %probability of strain P to be killed by S
...
for t = 1:2000
    ...
    imagesc(rgbImage);
    path='/Users/ariannamiano/Desktop/PhD/ModelRPSPlate/Concentric_circles_images/InnerRsmaller';
